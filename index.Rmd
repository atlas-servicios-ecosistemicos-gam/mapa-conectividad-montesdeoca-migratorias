---
title: "Mapa de conectividad de grupos funcionales de aves migratorias en el cantón de Montes de Oca"
output: 
...
url_raster_probabilidad_conectividad <-
  "https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos/master/conectividad/montesdeoca/migratorias/PROBABILIDAD_CONECTIVIDAD_MIGRATORIAS_MONTES_OCA_WEB.TIF"

url_agfs_teselas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_parches_esenciales_importantes_migratorias_montes_oca/FeatureServer/0"

url_agfs_rutas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_rutas_conectividad_migratorias_montes_oca/FeatureServer/0"
...
# Esencialidad
bins_esencialidad <- c(0, 0.004151, 0.010627, 0.016699, 0.056890, Inf)
...
# Importancia
bins_importancia <- c(0, 335781358814.00, 1597446988620.00, 6411280869840.00, 13259090953500.00, Inf)
